...
class ActorCountViewController: UIViewController, ActorSocketConnectorDelegate {
  ...
  private let socketConnector: ActorSocketConnector
  ...
  init(socket: ActorSocketConnector) {
  ...
  private func connectSocket() {
    Task {
      ...
      await self.socketConnector.setDelegate(self)
